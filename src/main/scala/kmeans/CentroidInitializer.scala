...
object CentroidInitializer {
  val bidimensionalRandomInitializer = new CentroidInitializer[BidimensionalPoint] {
  ...
  val kmeansBidimensionalInitializer = new CentroidInitializer[BidimensionalPoint] {
